 ...
 */
@MathCatDsl
fun <R, S, T> Suspended<R, suspend (S) -> T>.apply(): suspend (Suspended<R, S>)-> Suspended<R, T> = {
 ...
 */
@MathCatDsl
suspend infix fun <R, S, T> Suspended<R, suspend (S) -> T>.apply(other: Suspended<R, S>): Suspended<R, T> = apply()(other)
